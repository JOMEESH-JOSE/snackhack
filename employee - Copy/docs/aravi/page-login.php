...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form"  name = "myform" action="index.html" method="post" onsubmit="return validate()" >
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN</h3>
          <div class="form-group">
            <label class="control-label">USERNAME</label>
            <input class="form-control" type="text"  name = "uname" placeholder="Username" autofocus>
          </div>
          <div class="form-group">
