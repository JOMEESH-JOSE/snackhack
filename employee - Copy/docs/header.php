  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="blank-page.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">add food items</span></a>
